...
module.exports = {
  ...
  report: function (taskReport) {
    console.log('-------------------------------')
    console.log(taskReport)
    console.log('-------------------------------')

    var orderId = taskReport.orderId
    ...
    var laborId = taskReport.laborId
    ...
    var order = this.orders[orderId]
    var labor = this.labors[laborId]
    var action = taskReport.action

    if (action === 'end') {
      order.report(taskReport)
  ...
  info: function (labor) {
    var rt = {}
    var availableLabors = this.availableLabors
    rt[labor.id] = {trait: labor.trait, isFree: labor.id in availableLabors ? true : false}
    return rt
  },
